<form method="post" action="create" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Name</label>
        <input type="text_field" class="form-control" placeholder="Input name ..." name="name"/>
    </div>
    <div class="form-group">
        <label>Price</label>
        <input type="text_field" class="form-control" placeholder="Input price ..." name="price"/>
    </div>
    <div class="form-group">
        <label>Sale</label>
        <input type="text_field" class="form-control" placeholder="Input sale ..." name="sale"/>
    </div>
    <div class="form-group">
        <label>Image</label>
